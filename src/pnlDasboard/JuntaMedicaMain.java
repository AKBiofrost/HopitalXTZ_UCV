 ...
 */
public class JuntaMedicaMain extends javax.swing.JFrame {

    /**
     * Creates new form jundamedica
     */
    public JuntaMedicaMain() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JuntaMedicaMain.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JuntaMedicaMain().setVisible(true);
            }
        });
    }
