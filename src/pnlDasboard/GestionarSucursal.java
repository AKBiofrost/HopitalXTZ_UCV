 ...
 */
public class GestionarSucursal extends javax.swing.JFrame {

    /**
     * Creates new form GestionarSucursal
     */
    public GestionarSucursal() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Consultar sucursal");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GestionarSucursal().setVisible(true);
            }
        });
    }
