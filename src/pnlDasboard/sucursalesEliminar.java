 ...
 */
public class SucursalesEliminar extends javax.swing.JFrame {

    /**
     * Creates new form jundamedica
     */
    public SucursalesEliminar() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Sucursales - Eliminar");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SucursalesEliminar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SucursalesEliminar().setVisible(true);
            }
        });
    }
